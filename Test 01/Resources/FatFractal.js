...
function FatFractal() {
     ...
     */
    var m_version = "FF_JAVASCRIPT_SDK_BETA_5_R2106";
    ...
    */
        ...
        m_ajax({
            ...
            data: null,
                   success: function(response) {
                       ...
                       if (!response.result.authorizationUri) {
    ...
    this.retrieveAccessTokenForScriptAuthService = function(scriptAuthService, callbackUriWithVerifier, successCallback, errorCallback) {
        ...
        var query = callbackUriWithVerifier.substr(callbackUriWithVerifier.indexOf("?"));

        var url = this.getBaseUrl() + "/ff/auth?action=getToken&scriptAuthService=" + scriptAuthService + "&callbackUri=" + encodeURIComponent(callbackUri) + "&codeQuery=" + encodeURIComponent(callbackUriWithVerifier);
...
//                successCallback(retVal, response.statusMessage);
    ...
    */
    ...
    this.executeFFDL = function(ffdl, successCallback, errorCallback) {
        ...
        var url = this.getSSLUrl() + "ff/metadata";
